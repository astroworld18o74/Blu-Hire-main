...
if ($formfield == "company") {
    ...
    elseif(preg_match('/[\'\/~`\!@#\$%\^&\*\(\)_\-\+=\{\}\[\]\|;:"\<\>,\.\?\\\]/',$value)) {
        echo "Company name contain invalid characters";
    }
